...
(defn- exercise [s]
  (store/commit-record! s {:effect :engagement/upsert
                           :value {:id "eng-x" :operator "X SARL" :jurisdiction "BDI"
                                   :base-fee 1000000 :monthly-rate 100000 :monitoring-months 1
                                   :claimed-fee 1100000.0
                                   :gre-a-gre-base-value 5000000 :gre-a-gre-complementaire-value 500000
  ...
  (store/commit-record! s {:effect :assessment/set
                           :path ["eng-x"]
                           :payload {:jurisdiction "BDI" :checklist ["a"] :spec-basis "x"}})

(ns marketentry.marketentryllm
  ...
  the Burundi (BDI) public-sector market-entry compliance actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "gre-a-gre-base-value=" (:gre-a-gre-base-value e)
                        " gre-a-gre-complementaire-value=" (:gre-a-gre-complementaire-value e)
                        " gre-a-gre-claim?=" (:gre-a-gre-claim? e)
